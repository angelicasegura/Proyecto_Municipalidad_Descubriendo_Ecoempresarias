...
export function EmprendimientoCard({ emprendedor, tiposActividad }: EmprendimientoCardProps) {
    ...
    <Card className="group overflow-hidden border-border hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer">
      <div className="relative aspect-[16/10] overflow-hidden bg-muted">
        {emprendedor.ruta_Imagen_Logo ? (
          <img
            src={`https://localhost:7050/api/emprendimientos/imagen/${emprendedor.ruta_Imagen_Logo}`}
