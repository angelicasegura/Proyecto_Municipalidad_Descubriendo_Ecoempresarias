...
export function Footer() {
  return (
    <footer className="bg-[#056F94] gradient-hero text-white py-12 px-8">
      <div className="mx-auto max-w-300">
        <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-8 mb-8">
          {footerSections.map((section) => (
            <div key={section.title}>
              <h4 className="text-[#FFD177] mb-4 text-base font-semibold">{section.title}</h4>
        ...
        <div className="pt-6 border-t border-white/20 text-center">
          <p className="text-[#cfcfcf] text-[0.9rem]">
