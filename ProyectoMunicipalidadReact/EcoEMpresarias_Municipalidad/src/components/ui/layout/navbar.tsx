...
export function Navbar() {
  ...
  return (
    <nav className="bg-[#0066aa] text-primary-foreground sticky top-0 z-50 shadow-md">
      <div className="mx-auto max-w-350px px-4 sm:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-primary border-0 rounded-lg">
                <DropdownMenuItem asChild className="text-foreground hover:bg-accent hover:text-white cursor-pointer">
                ...
                <DropdownMenuItem asChild className="text-foreground hover:bg-accent hover:text-white cursor-pointer">
                  <Link to="/emprendimientos-admin">Gestión de emprendimientos</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="text-foreground hover:bg-accent hover:text-white cursor-pointer">
                ...
                <DropdownMenuItem asChild className="text-foreground hover:bg-accent hover:text-white cursor-pointer">
                  <Link to="/inteligencia-municipal">Sistema de Inteligencia Municipal</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="text-foreground hover:bg-accent hover:text-white cursor-pointer">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 space-y-2 border-t border-white/20">
            <Link to="/emprendedores" className="block py-2 text-white font-medium hover:text-accent">
              Emprendedores
            </Link>
            <Link to="/productos" className="block py-2 text-white font-medium hover:text-accent">
              Productos
            </Link>
            <Link to="/carrito" className="block py-2 text-white font-medium hover:text-accent">
              Carrito
            </Link>
            <Link to="/eventos" className="block py-2 text-white font-medium hover:text-accent">
              Eventos
            </Link>
            <Link to="/entregas" className="block py-2 text-white font-medium hover:text-accent">
              Entregas y seguimientos
            </Link>
            <Link to="/mapas" className="block py-2 text-white font-medium hover:text-accent">
              Mapas
            </Link>
            <div className="pt-4">
